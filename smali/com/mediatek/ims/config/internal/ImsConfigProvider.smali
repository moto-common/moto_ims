...
.method private notifyChange(Landroid/net/Uri;Lcom/mediatek/ims/config/internal/ImsConfigProvider$Arguments;Landroid/content/ContentValues;)V
    ...
    .local v18, "isECCBroadcastFlag":Z
    .local v19, "isFeatureEnabled":Z
    ...
    iget-object v4, v1, Lcom/mediatek/ims/config/internal/ImsConfigProvider$Arguments;->table:Ljava/lang/String;
    ...
    .line 339
    .end local v18    # "isECCBroadcastFlag":Z
    .end local v19    # "isFeatureEnabled":Z
    .restart local v4    # "isECCBroadcastFlag":Z
    ...
    .end local v4    # "isECCBroadcastFlag":Z
    .restart local v18    # "isECCBroadcastFlag":Z
    iget-object v4, v1, Lcom/mediatek/ims/config/internal/ImsConfigProvider$Arguments;->phoneId:Ljava/lang/String;
    ...
    .end local v5    # "isFeatureEnabled":Z
    .restart local v19    # "isFeatureEnabled":Z
    ...
    .local v21, "valueStr":Ljava/lang/String;
    ...
    .end local v6    # "isECCBroadcastFlag":Z
    .local v17, "isECCBroadcastFlag":Z
    sget-object v6, Lcom/mediatek/ims/config/internal/ImsConfigProvider;->ECCAllowBroadcast:Ljava/util/HashMap;

    move/from16 v18, v7

    .end local v7    # "isFeatureEnabled":Z
    .local v18, "isFeatureEnabled":Z
    iget-object v7, v1, Lcom/mediatek/ims/config/internal/ImsConfigProvider$Arguments;->phoneId:Ljava/lang/String;
    ...
    .line 295
    .end local v17    # "isECCBroadcastFlag":Z
    .end local v18    # "isFeatureEnabled":Z
    .restart local v6    # "isECCBroadcastFlag":Z
    ...
    .end local v6    # "isECCBroadcastFlag":Z
    .end local v7    # "isFeatureEnabled":Z
    .restart local v17    # "isECCBroadcastFlag":Z
    .restart local v18    # "isFeatureEnabled":Z
    :goto_4
    move/from16 v6, v17
    ...
    const-string v12, "isForceNotify "
    ...
    .end local v20    # "isSimStateAllow":Z
    .local v12, "isSimStateAllow":Z
    goto :goto_9

    .line 314
    .end local v12    # "isSimStateAllow":Z
    .restart local v20    # "isSimStateAllow":Z
    :cond_9
    :goto_8
    const/4 v12, 0x1
    ...
    .line 319
    .end local v20    # "isSimStateAllow":Z
    .restart local v12    # "isSimStateAllow":Z
    :goto_9
    if-nez v12, :cond_c
    ...
    invoke-virtual {v10, v0, v13}, Landroid/content/ContentResolver;->notifyChange(Landroid/net/Uri;Landroid/database/ContentObserver;)V

    .line 331
    sget-object v10, Lcom/mediatek/ims/config/internal/ImsConfigProvider;->ECCAllowBroadcast:Ljava/util/HashMap;
    ...
    iget-object v9, v1, Lcom/mediatek/ims/config/internal/ImsConfigProvider$Arguments;->phoneId:Ljava/lang/String;
    ...
    .end local v12    # "isSimStateAllow":Z
    .end local v18    # "isFeatureEnabled":Z
    .end local v21    # "valueStr":Ljava/lang/String;
    .local v4, "isECCBroadcastFlag":Z
    .local v5, "isFeatureEnabled":Z
    .local v6, "isSimStateAllow":Z
    .local v7, "valueStr":Ljava/lang/String;
    ...
    .restart local v19    # "isFeatureEnabled":Z
    .restart local v20    # "isSimStateAllow":Z
    .restart local v21    # "valueStr":Ljava/lang/String;
    ...
    const-string v12, "com.android.intent.action.IMS_CONFIG_CHANGED"
    ...
    .line 248
    invoke-virtual {v8, v13, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;
    ...
    invoke-virtual {v10, v0, v12}, Landroid/content/ContentResolver;->notifyChange(Landroid/net/Uri;Landroid/database/ContentObserver;)V

    .line 261
    if-nez v4, :cond_11

    sget-boolean v10, Lcom/mediatek/ims/config/internal/ImsConfigProvider;->DEBUG:Z
